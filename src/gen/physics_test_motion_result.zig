...
var mbind_physics_test_motion_result_constructor: ?fn () ?*c_api.godot_object = null;

pub const PhysicsTestMotionResult = struct {
    const Self = @This();
    ...
    pub fn init() !*Self {
        if (mbind_physics_test_motion_result_constructor == null) {
            mbind_physics_test_motion_result_constructor = try api.createConstructor("PhysicsTestMotionResult");
        }
        return api.createObject(Self, mbind_physics_test_motion_result_constructor.?);
    }
    ...
    pub fn getCollider(self: *const Self) !godot.Object {
        if (mbind_get_collider == null) {
            mbind_get_collider = try api.createMethod("PhysicsTestMotionResult", "get_collider");
        }
    ...
    pub fn getColliderId(self: *const Self) !i32 {
        if (mbind_get_collider_id == null) {
            mbind_get_collider_id = try api.createMethod("PhysicsTestMotionResult", "get_collider_id");
        }
    ...
    pub fn getColliderRid(self: *const Self) !godot.RID {
        if (mbind_get_collider_rid == null) {
            mbind_get_collider_rid = try api.createMethod("PhysicsTestMotionResult", "get_collider_rid");
        }
    ...
    pub fn getColliderShape(self: *const Self) !i32 {
        if (mbind_get_collider_shape == null) {
            mbind_get_collider_shape = try api.createMethod("PhysicsTestMotionResult", "get_collider_shape");
        }
    ...
    pub fn getColliderVelocity(self: *const Self) !godot.Vector3 {
        if (mbind_get_collider_velocity == null) {
            mbind_get_collider_velocity = try api.createMethod("PhysicsTestMotionResult", "get_collider_velocity");
        }
    ...
    pub fn getCollisionDepth(self: *const Self) !f32 {
        if (mbind_get_collision_depth == null) {
            mbind_get_collision_depth = try api.createMethod("PhysicsTestMotionResult", "get_collision_depth");
        }
    ...
    pub fn getCollisionNormal(self: *const Self) !godot.Vector3 {
        if (mbind_get_collision_normal == null) {
            mbind_get_collision_normal = try api.createMethod("PhysicsTestMotionResult", "get_collision_normal");
        }
    ...
    pub fn getCollisionPoint(self: *const Self) !godot.Vector3 {
        if (mbind_get_collision_point == null) {
            mbind_get_collision_point = try api.createMethod("PhysicsTestMotionResult", "get_collision_point");
        }
    ...
    pub fn getCollisionSafeFraction(self: *const Self) !f32 {
        if (mbind_get_collision_safe_fraction == null) {
            mbind_get_collision_safe_fraction = try api.createMethod("PhysicsTestMotionResult", "get_collision_safe_fraction");
        }
    ...
    pub fn getCollisionUnsafeFraction(self: *const Self) !f32 {
        if (mbind_get_collision_unsafe_fraction == null) {
            mbind_get_collision_unsafe_fraction = try api.createMethod("PhysicsTestMotionResult", "get_collision_unsafe_fraction");
        }
    ...
    pub fn getMotion(self: *const Self) !godot.Vector3 {
        if (mbind_get_motion == null) {
            mbind_get_motion = try api.createMethod("PhysicsTestMotionResult", "get_motion");
        }
    ...
    pub fn getMotionRemainder(self: *const Self) !godot.Vector3 {
        if (mbind_get_motion_remainder == null) {
            mbind_get_motion_remainder = try api.createMethod("PhysicsTestMotionResult", "get_motion_remainder");
        }
