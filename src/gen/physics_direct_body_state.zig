...
var mbind_get_center_of_mass: ?*c_api.godot_method_bind = null;
...
var mbind_get_contact_impulse: ?*c_api.godot_method_bind = null;
...
var mbind_get_principal_inertia_axes: ?*c_api.godot_method_bind = null;
...
var mbind_physics_direct_body_state_constructor: ?fn () ?*c_api.godot_object = null;

pub const PhysicsDirectBodyState = struct {
    const Self = @This();
    ...
    pub fn init() !*Self {
        if (mbind_physics_direct_body_state_constructor == null) {
            mbind_physics_direct_body_state_constructor = try api.createConstructor("PhysicsDirectBodyState");
        }
        return api.createObject(Self, mbind_physics_direct_body_state_constructor.?);
    }
    ...
    pub fn addCentralForce(self: *const Self, arg_force: *const godot.Vector3) !void {
        if (mbind_add_central_force == null) {
            mbind_add_central_force = try api.createMethod("PhysicsDirectBodyState", "add_central_force");
        }
    ...
    pub fn addForce(self: *const Self, arg_force: *const godot.Vector3, arg_position: *const godot.Vector3) !void {
        if (mbind_add_force == null) {
            mbind_add_force = try api.createMethod("PhysicsDirectBodyState", "add_force");
        }
    ...
    pub fn addTorque(self: *const Self, arg_torque: *const godot.Vector3) !void {
        if (mbind_add_torque == null) {
            mbind_add_torque = try api.createMethod("PhysicsDirectBodyState", "add_torque");
        }
    ...
    pub fn applyCentralImpulse(self: *const Self, arg_j: *const godot.Vector3) !void {
        if (mbind_apply_central_impulse == null) {
            mbind_apply_central_impulse = try api.createMethod("PhysicsDirectBodyState", "apply_central_impulse");
        }

        var result: ?*anyopaque = null;
        var args: [1]?*const anyopaque = []?*const anyopaque {
            @ptrCast(*const anyopaque, arg_j),
        };
    ...
    pub fn applyImpulse(self: *const Self, arg_position: *const godot.Vector3, arg_j: *const godot.Vector3) !void {
        if (mbind_apply_impulse == null) {
            mbind_apply_impulse = try api.createMethod("PhysicsDirectBodyState", "apply_impulse");
        }
    ...
    pub fn applyTorqueImpulse(self: *const Self, arg_j: *const godot.Vector3) !void {
        if (mbind_apply_torque_impulse == null) {
            mbind_apply_torque_impulse = try api.createMethod("PhysicsDirectBodyState", "apply_torque_impulse");
        }
    ...
    pub fn getAngularVelocity(self: *const Self) !godot.Vector3 {
        if (mbind_get_angular_velocity == null) {
            mbind_get_angular_velocity = try api.createMethod("PhysicsDirectBodyState", "get_angular_velocity");
        }
    ...
    pub fn getCenterOfMass(self: *const Self) !godot.Vector3 {
        if (mbind_get_center_of_mass == null) {
            mbind_get_center_of_mass = try api.createMethod("PhysicsDirectBodyState", "get_center_of_mass");
        }
        ...
        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_get_center_of_mass, base, cargs, result);
        return @ptrCast(*godot.Vector3, @alignCast(@alignOf(&godot.Vector3), result)).*;
    }

    pub fn getContactCollider(self: *const Self, arg_contact_idx: i32) !godot.RID {
        if (mbind_get_contact_collider == null) {
            mbind_get_contact_collider = try api.createMethod("PhysicsDirectBodyState", "get_contact_collider");
        }
    ...
    pub fn getContactColliderId(self: *const Self, arg_contact_idx: i32) !i32 {
        if (mbind_get_contact_collider_id == null) {
            mbind_get_contact_collider_id = try api.createMethod("PhysicsDirectBodyState", "get_contact_collider_id");
        }
    ...
    pub fn getContactColliderObject(self: *const Self, arg_contact_idx: i32) !godot.Object {
        if (mbind_get_contact_collider_object == null) {
            mbind_get_contact_collider_object = try api.createMethod("PhysicsDirectBodyState", "get_contact_collider_object");
        }
    ...
    pub fn getContactColliderPosition(self: *const Self, arg_contact_idx: i32) !godot.Vector3 {
        if (mbind_get_contact_collider_position == null) {
            mbind_get_contact_collider_position = try api.createMethod("PhysicsDirectBodyState", "get_contact_collider_position");
        }
    ...
    pub fn getContactColliderShape(self: *const Self, arg_contact_idx: i32) !i32 {
        if (mbind_get_contact_collider_shape == null) {
            mbind_get_contact_collider_shape = try api.createMethod("PhysicsDirectBodyState", "get_contact_collider_shape");
        }
    ...
    pub fn getContactColliderVelocityAtPosition(self: *const Self, arg_contact_idx: i32) !godot.Vector3 {
        if (mbind_get_contact_collider_velocity_at_position == null) {
            mbind_get_contact_collider_velocity_at_position = try api.createMethod("PhysicsDirectBodyState", "get_contact_collider_velocity_at_position");
        }
    ...
    pub fn getContactCount(self: *const Self) !i32 {
        if (mbind_get_contact_count == null) {
            mbind_get_contact_count = try api.createMethod("PhysicsDirectBodyState", "get_contact_count");
        }
    ...
    pub fn getContactImpulse(self: *const Self, arg_contact_idx: i32) !f32 {
        if (mbind_get_contact_impulse == null) {
            mbind_get_contact_impulse = try api.createMethod("PhysicsDirectBodyState", "get_contact_impulse");
        }
        ...
        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_get_contact_impulse, base, cargs, result);
        return @ptrCast(*f32, @alignCast(@alignOf(&f32), result)).*;
    }

    pub fn getContactLocalNormal(self: *const Self, arg_contact_idx: i32) !godot.Vector3 {
        if (mbind_get_contact_local_normal == null) {
            mbind_get_contact_local_normal = try api.createMethod("PhysicsDirectBodyState", "get_contact_local_normal");
        }
    ...
    pub fn getContactLocalPosition(self: *const Self, arg_contact_idx: i32) !godot.Vector3 {
        if (mbind_get_contact_local_position == null) {
            mbind_get_contact_local_position = try api.createMethod("PhysicsDirectBodyState", "get_contact_local_position");
        }
    ...
    pub fn getContactLocalShape(self: *const Self, arg_contact_idx: i32) !i32 {
        if (mbind_get_contact_local_shape == null) {
            mbind_get_contact_local_shape = try api.createMethod("PhysicsDirectBodyState", "get_contact_local_shape");
        }
    ...
    pub fn getInverseInertia(self: *const Self) !godot.Vector3 {
        if (mbind_get_inverse_inertia == null) {
            mbind_get_inverse_inertia = try api.createMethod("PhysicsDirectBodyState", "get_inverse_inertia");
        }
    ...
    pub fn getInverseMass(self: *const Self) !f32 {
        if (mbind_get_inverse_mass == null) {
            mbind_get_inverse_mass = try api.createMethod("PhysicsDirectBodyState", "get_inverse_mass");
        }
    ...
    pub fn getLinearVelocity(self: *const Self) !godot.Vector3 {
        if (mbind_get_linear_velocity == null) {
            mbind_get_linear_velocity = try api.createMethod("PhysicsDirectBodyState", "get_linear_velocity");
        }
    ...
    pub fn getPrincipalInertiaAxes(self: *const Self) !godot.Basis {
        if (mbind_get_principal_inertia_axes == null) {
            mbind_get_principal_inertia_axes = try api.createMethod("PhysicsDirectBodyState", "get_principal_inertia_axes");
        }
        ...
        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_get_principal_inertia_axes, base, cargs, result);
        return @ptrCast(*godot.Basis, @alignCast(@alignOf(&godot.Basis), result)).*;
    }

    pub fn getSpaceState(self: *const Self) !godot.PhysicsDirectSpaceState {
        if (mbind_get_space_state == null) {
            mbind_get_space_state = try api.createMethod("PhysicsDirectBodyState", "get_space_state");
        }
    ...
    pub fn getStep(self: *const Self) !f32 {
        if (mbind_get_step == null) {
            mbind_get_step = try api.createMethod("PhysicsDirectBodyState", "get_step");
        }
    ...
    pub fn getTotalAngularDamp(self: *const Self) !f32 {
        if (mbind_get_total_angular_damp == null) {
            mbind_get_total_angular_damp = try api.createMethod("PhysicsDirectBodyState", "get_total_angular_damp");
        }
    ...
    pub fn getTotalGravity(self: *const Self) !godot.Vector3 {
        if (mbind_get_total_gravity == null) {
            mbind_get_total_gravity = try api.createMethod("PhysicsDirectBodyState", "get_total_gravity");
        }
    ...
    pub fn getTotalLinearDamp(self: *const Self) !f32 {
        if (mbind_get_total_linear_damp == null) {
            mbind_get_total_linear_damp = try api.createMethod("PhysicsDirectBodyState", "get_total_linear_damp");
        }
    ...
    pub fn getTransform(self: *const Self) !godot.Transform {
        if (mbind_get_transform == null) {
            mbind_get_transform = try api.createMethod("PhysicsDirectBodyState", "get_transform");
        }
    ...
    pub fn getVelocityAtLocalPosition(self: *const Self, arg_local_position: *const godot.Vector3) !godot.Vector3 {
        if (mbind_get_velocity_at_local_position == null) {
            mbind_get_velocity_at_local_position = try api.createMethod("PhysicsDirectBodyState", "get_velocity_at_local_position");
        }
    ...
    pub fn integrateForces(self: *const Self) !void {
        if (mbind_integrate_forces == null) {
            mbind_integrate_forces = try api.createMethod("PhysicsDirectBodyState", "integrate_forces");
        }
    ...
    pub fn isSleeping(self: *const Self) !bool {
        if (mbind_is_sleeping == null) {
            mbind_is_sleeping = try api.createMethod("PhysicsDirectBodyState", "is_sleeping");
        }
    ...
    pub fn setAngularVelocity(self: *const Self, arg_velocity: *const godot.Vector3) !void {
        if (mbind_set_angular_velocity == null) {
            mbind_set_angular_velocity = try api.createMethod("PhysicsDirectBodyState", "set_angular_velocity");
        }
    ...
    pub fn setLinearVelocity(self: *const Self, arg_velocity: *const godot.Vector3) !void {
        if (mbind_set_linear_velocity == null) {
            mbind_set_linear_velocity = try api.createMethod("PhysicsDirectBodyState", "set_linear_velocity");
        }
    ...
    pub fn setSleepState(self: *const Self, arg_enabled: bool) !void {
        if (mbind_set_sleep_state == null) {
            mbind_set_sleep_state = try api.createMethod("PhysicsDirectBodyState", "set_sleep_state");
        }
    ...
    pub fn setTransform(self: *const Self, arg_transform: *const godot.Transform) !void {
        if (mbind_set_transform == null) {
            mbind_set_transform = try api.createMethod("PhysicsDirectBodyState", "set_transform");
        }
