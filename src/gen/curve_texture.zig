...
var mbind_curve_texture_constructor: ?fn () ?*c_api.godot_object = null;
...
pub const CurveTexture = struct {
    ...
    pub fn init() !*Self {
        if (mbind_curve_texture_constructor == null) {
            mbind_curve_texture_constructor = try api.createConstructor("CurveTexture");
        }
        return api.createObject(Self, mbind_curve_texture_constructor.?);
    }
    ...
    pub fn getCurve(self: *const Self) !godot.Curve {
        if (mbind_get_curve == null) {
            mbind_get_curve = try api.createMethod("CurveTexture", "get_curve");
        }
    ...
    pub fn setCurve(self: *const Self, arg_curve: *const godot.Curve) !void {
        if (mbind_set_curve == null) {
            mbind_set_curve = try api.createMethod("CurveTexture", "set_curve");
        }
    ...
    pub fn setWidth(self: *const Self, arg_width: i32) !void {
        if (mbind_set_width == null) {
            mbind_set_width = try api.createMethod("CurveTexture", "set_width");
        }
