...
var mbind_get_emission_rect_extents: ?*c_api.godot_method_bind = null;
...
var mbind_get_normalmap: ?*c_api.godot_method_bind = null;
...
var mbind_set_emission_rect_extents: ?*c_api.godot_method_bind = null;
...
var mbind_set_normalmap: ?*c_api.godot_method_bind = null;
...
var mbind_cpuparticles_2d_constructor: ?fn () ?*c_api.godot_object = null;

pub const CPUParticles2D = struct {
    const Self = @This();
    ...
    pub fn init() !*Self {
        if (mbind_cpuparticles_2d_constructor == null) {
            mbind_cpuparticles_2d_constructor = try api.createConstructor("CPUParticles2D");
        }
        return api.createObject(Self, mbind_cpuparticles_2d_constructor.?);
    }
    ...
    pub fn convertFromParticles(self: *const Self, arg_particles: *const godot.Node) !void {
        if (mbind_convert_from_particles == null) {
            mbind_convert_from_particles = try api.createMethod("CPUParticles2D", "convert_from_particles");
        }
    ...
    pub fn getAmount(self: *const Self) !i32 {
        if (mbind_get_amount == null) {
            mbind_get_amount = try api.createMethod("CPUParticles2D", "get_amount");
        }
    ...
    pub fn getColor(self: *const Self) !godot.Color {
        if (mbind_get_color == null) {
            mbind_get_color = try api.createMethod("CPUParticles2D", "get_color");
        }
    ...
    pub fn getColorRamp(self: *const Self) !godot.Gradient {
        if (mbind_get_color_ramp == null) {
            mbind_get_color_ramp = try api.createMethod("CPUParticles2D", "get_color_ramp");
        }
    ...
    pub fn getDirection(self: *const Self) !godot.Vector2 {
        if (mbind_get_direction == null) {
            mbind_get_direction = try api.createMethod("CPUParticles2D", "get_direction");
        }
    ...
    pub fn getDrawOrder(self: *const Self) !i32 {
        if (mbind_get_draw_order == null) {
            mbind_get_draw_order = try api.createMethod("CPUParticles2D", "get_draw_order");
        }
    ...
    pub fn getEmissionColors(self: *const Self) !godot.PoolColorArray {
        if (mbind_get_emission_colors == null) {
            mbind_get_emission_colors = try api.createMethod("CPUParticles2D", "get_emission_colors");
        }
    ...
    pub fn getEmissionNormals(self: *const Self) !godot.PoolVector2Array {
        if (mbind_get_emission_normals == null) {
            mbind_get_emission_normals = try api.createMethod("CPUParticles2D", "get_emission_normals");
        }
    ...
    pub fn getEmissionPoints(self: *const Self) !godot.PoolVector2Array {
        if (mbind_get_emission_points == null) {
            mbind_get_emission_points = try api.createMethod("CPUParticles2D", "get_emission_points");
        }
    ...
    pub fn getEmissionRectExtents(self: *const Self) !godot.Vector2 {
        if (mbind_get_emission_rect_extents == null) {
            mbind_get_emission_rect_extents = try api.createMethod("CPUParticles2D", "get_emission_rect_extents");
        }
        ...
        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_get_emission_rect_extents, base, cargs, result);
        return @ptrCast(*godot.Vector2, @alignCast(@alignOf(&godot.Vector2), result)).*;
    }

    pub fn getEmissionShape(self: *const Self) !i32 {
        if (mbind_get_emission_shape == null) {
            mbind_get_emission_shape = try api.createMethod("CPUParticles2D", "get_emission_shape");
        }
    ...
    pub fn getEmissionSphereRadius(self: *const Self) !f32 {
        if (mbind_get_emission_sphere_radius == null) {
            mbind_get_emission_sphere_radius = try api.createMethod("CPUParticles2D", "get_emission_sphere_radius");
        }
    ...
    pub fn getExplosivenessRatio(self: *const Self) !f32 {
        if (mbind_get_explosiveness_ratio == null) {
            mbind_get_explosiveness_ratio = try api.createMethod("CPUParticles2D", "get_explosiveness_ratio");
        }
    ...
    pub fn getFixedFps(self: *const Self) !i32 {
        if (mbind_get_fixed_fps == null) {
            mbind_get_fixed_fps = try api.createMethod("CPUParticles2D", "get_fixed_fps");
        }
    ...
    pub fn getFractionalDelta(self: *const Self) !bool {
        if (mbind_get_fractional_delta == null) {
            mbind_get_fractional_delta = try api.createMethod("CPUParticles2D", "get_fractional_delta");
        }
    ...
    pub fn getGravity(self: *const Self) !godot.Vector2 {
        if (mbind_get_gravity == null) {
            mbind_get_gravity = try api.createMethod("CPUParticles2D", "get_gravity");
        }
    ...
    pub fn getLifetime(self: *const Self) !f32 {
        if (mbind_get_lifetime == null) {
            mbind_get_lifetime = try api.createMethod("CPUParticles2D", "get_lifetime");
        }
    ...
    pub fn getLifetimeRandomness(self: *const Self) !f32 {
        if (mbind_get_lifetime_randomness == null) {
            mbind_get_lifetime_randomness = try api.createMethod("CPUParticles2D", "get_lifetime_randomness");
        }
    ...
    pub fn getNormalmap(self: *const Self) !godot.Texture {
        if (mbind_get_normalmap == null) {
            mbind_get_normalmap = try api.createMethod("CPUParticles2D", "get_normalmap");
        }
        ...
        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_get_normalmap, base, cargs, result);
    ...
    pub fn getOneShot(self: *const Self) !bool {
        if (mbind_get_one_shot == null) {
            mbind_get_one_shot = try api.createMethod("CPUParticles2D", "get_one_shot");
        }
    ...
    pub fn getParam(self: *const Self, arg_param: i32) !f32 {
        if (mbind_get_param == null) {
            mbind_get_param = try api.createMethod("CPUParticles2D", "get_param");
        }
    ...
    pub fn getParamCurve(self: *const Self, arg_param: i32) !godot.Curve {
        if (mbind_get_param_curve == null) {
            mbind_get_param_curve = try api.createMethod("CPUParticles2D", "get_param_curve");
        }
    ...
    pub fn getParamRandomness(self: *const Self, arg_param: i32) !f32 {
        if (mbind_get_param_randomness == null) {
            mbind_get_param_randomness = try api.createMethod("CPUParticles2D", "get_param_randomness");
        }
    ...
    pub fn getParticleFlag(self: *const Self, arg_flag: i32) !bool {
        if (mbind_get_particle_flag == null) {
            mbind_get_particle_flag = try api.createMethod("CPUParticles2D", "get_particle_flag");
        }
    ...
    pub fn getPreProcessTime(self: *const Self) !f32 {
        if (mbind_get_pre_process_time == null) {
            mbind_get_pre_process_time = try api.createMethod("CPUParticles2D", "get_pre_process_time");
        }
    ...
    pub fn getRandomnessRatio(self: *const Self) !f32 {
        if (mbind_get_randomness_ratio == null) {
            mbind_get_randomness_ratio = try api.createMethod("CPUParticles2D", "get_randomness_ratio");
        }
    ...
    pub fn getSpeedScale(self: *const Self) !f32 {
        if (mbind_get_speed_scale == null) {
            mbind_get_speed_scale = try api.createMethod("CPUParticles2D", "get_speed_scale");
        }
    ...
    pub fn getSpread(self: *const Self) !f32 {
        if (mbind_get_spread == null) {
            mbind_get_spread = try api.createMethod("CPUParticles2D", "get_spread");
        }
    ...
    pub fn getTexture(self: *const Self) !godot.Texture {
        if (mbind_get_texture == null) {
            mbind_get_texture = try api.createMethod("CPUParticles2D", "get_texture");
        }
    ...
    pub fn getUseLocalCoordinates(self: *const Self) !bool {
        if (mbind_get_use_local_coordinates == null) {
            mbind_get_use_local_coordinates = try api.createMethod("CPUParticles2D", "get_use_local_coordinates");
        }
    ...
    pub fn isEmitting(self: *const Self) !bool {
        if (mbind_is_emitting == null) {
            mbind_is_emitting = try api.createMethod("CPUParticles2D", "is_emitting");
        }
    ...
    pub fn restart(self: *const Self) !void {
        if (mbind_restart == null) {
            mbind_restart = try api.createMethod("CPUParticles2D", "restart");
        }
    ...
    pub fn setAmount(self: *const Self, arg_amount: i32) !void {
        if (mbind_set_amount == null) {
            mbind_set_amount = try api.createMethod("CPUParticles2D", "set_amount");
        }
    ...
    pub fn setColor(self: *const Self, arg_color: *const godot.Color) !void {
        if (mbind_set_color == null) {
            mbind_set_color = try api.createMethod("CPUParticles2D", "set_color");
        }
    ...
    pub fn setColorRamp(self: *const Self, arg_ramp: *const godot.Gradient) !void {
        if (mbind_set_color_ramp == null) {
            mbind_set_color_ramp = try api.createMethod("CPUParticles2D", "set_color_ramp");
        }
    ...
    pub fn setDirection(self: *const Self, arg_direction: *const godot.Vector2) !void {
        if (mbind_set_direction == null) {
            mbind_set_direction = try api.createMethod("CPUParticles2D", "set_direction");
        }
    ...
    pub fn setDrawOrder(self: *const Self, arg_order: i32) !void {
        if (mbind_set_draw_order == null) {
            mbind_set_draw_order = try api.createMethod("CPUParticles2D", "set_draw_order");
        }
    ...
    pub fn setEmissionColors(self: *const Self, arg_array: *const godot.PoolColorArray) !void {
        if (mbind_set_emission_colors == null) {
            mbind_set_emission_colors = try api.createMethod("CPUParticles2D", "set_emission_colors");
        }
    ...
    pub fn setEmissionNormals(self: *const Self, arg_array: *const godot.PoolVector2Array) !void {
        if (mbind_set_emission_normals == null) {
            mbind_set_emission_normals = try api.createMethod("CPUParticles2D", "set_emission_normals");
        }
    ...
    pub fn setEmissionPoints(self: *const Self, arg_array: *const godot.PoolVector2Array) !void {
        if (mbind_set_emission_points == null) {
            mbind_set_emission_points = try api.createMethod("CPUParticles2D", "set_emission_points");
        }
    ...
    pub fn setEmissionRectExtents(self: *const Self, arg_extents: *const godot.Vector2) !void {
        if (mbind_set_emission_rect_extents == null) {
            mbind_set_emission_rect_extents = try api.createMethod("CPUParticles2D", "set_emission_rect_extents");
        }
        ...
        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_set_emission_rect_extents, base, cargs, result);
    }

    pub fn setEmissionShape(self: *const Self, arg_shape: i32) !void {
        if (mbind_set_emission_shape == null) {
            mbind_set_emission_shape = try api.createMethod("CPUParticles2D", "set_emission_shape");
        }
    ...
    pub fn setEmissionSphereRadius(self: *const Self, arg_radius: f32) !void {
        if (mbind_set_emission_sphere_radius == null) {
            mbind_set_emission_sphere_radius = try api.createMethod("CPUParticles2D", "set_emission_sphere_radius");
        }
    ...
    pub fn setEmitting(self: *const Self, arg_emitting: bool) !void {
        if (mbind_set_emitting == null) {
            mbind_set_emitting = try api.createMethod("CPUParticles2D", "set_emitting");
        }
    ...
    pub fn setExplosivenessRatio(self: *const Self, arg_ratio: f32) !void {
        if (mbind_set_explosiveness_ratio == null) {
            mbind_set_explosiveness_ratio = try api.createMethod("CPUParticles2D", "set_explosiveness_ratio");
        }
    ...
    pub fn setFixedFps(self: *const Self, arg_fps: i32) !void {
        if (mbind_set_fixed_fps == null) {
            mbind_set_fixed_fps = try api.createMethod("CPUParticles2D", "set_fixed_fps");
        }
    ...
    pub fn setFractionalDelta(self: *const Self, arg_enable: bool) !void {
        if (mbind_set_fractional_delta == null) {
            mbind_set_fractional_delta = try api.createMethod("CPUParticles2D", "set_fractional_delta");
        }
    ...
    pub fn setGravity(self: *const Self, arg_accel_vec: *const godot.Vector2) !void {
        if (mbind_set_gravity == null) {
            mbind_set_gravity = try api.createMethod("CPUParticles2D", "set_gravity");
        }
    ...
    pub fn setLifetime(self: *const Self, arg_secs: f32) !void {
        if (mbind_set_lifetime == null) {
            mbind_set_lifetime = try api.createMethod("CPUParticles2D", "set_lifetime");
        }
    ...
    pub fn setLifetimeRandomness(self: *const Self, arg_random: f32) !void {
        if (mbind_set_lifetime_randomness == null) {
            mbind_set_lifetime_randomness = try api.createMethod("CPUParticles2D", "set_lifetime_randomness");
        }
    ...
    pub fn setNormalmap(self: *const Self, arg_normalmap: *const godot.Texture) !void {
        if (mbind_set_normalmap == null) {
            mbind_set_normalmap = try api.createMethod("CPUParticles2D", "set_normalmap");
        }

        var result: ?*anyopaque = null;
        var args: [1]?*const anyopaque = []?*const anyopaque {
            @ptrCast(*const anyopaque, arg_normalmap),
        };

        var cargs: ?*?*const anyopaque = &args[0];

        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_set_normalmap, base, cargs, result);
    }

    pub fn setOneShot(self: *const Self, arg_enable: bool) !void {
        if (mbind_set_one_shot == null) {
            mbind_set_one_shot = try api.createMethod("CPUParticles2D", "set_one_shot");
        }
    ...
    pub fn setParam(self: *const Self, arg_param: i32, arg_value: f32) !void {
        if (mbind_set_param == null) {
            mbind_set_param = try api.createMethod("CPUParticles2D", "set_param");
        }
    ...
    pub fn setParamCurve(self: *const Self, arg_param: i32, arg_curve: *const godot.Curve) !void {
        if (mbind_set_param_curve == null) {
            mbind_set_param_curve = try api.createMethod("CPUParticles2D", "set_param_curve");
        }
    ...
    pub fn setParamRandomness(self: *const Self, arg_param: i32, arg_randomness: f32) !void {
        if (mbind_set_param_randomness == null) {
            mbind_set_param_randomness = try api.createMethod("CPUParticles2D", "set_param_randomness");
        }
    ...
    pub fn setParticleFlag(self: *const Self, arg_flag: i32, arg_enable: bool) !void {
        if (mbind_set_particle_flag == null) {
            mbind_set_particle_flag = try api.createMethod("CPUParticles2D", "set_particle_flag");
        }
    ...
    pub fn setPreProcessTime(self: *const Self, arg_secs: f32) !void {
        if (mbind_set_pre_process_time == null) {
            mbind_set_pre_process_time = try api.createMethod("CPUParticles2D", "set_pre_process_time");
        }
    ...
    pub fn setRandomnessRatio(self: *const Self, arg_ratio: f32) !void {
        if (mbind_set_randomness_ratio == null) {
            mbind_set_randomness_ratio = try api.createMethod("CPUParticles2D", "set_randomness_ratio");
        }
    ...
    pub fn setSpeedScale(self: *const Self, arg_scale: f32) !void {
        if (mbind_set_speed_scale == null) {
            mbind_set_speed_scale = try api.createMethod("CPUParticles2D", "set_speed_scale");
        }
    ...
    pub fn setSpread(self: *const Self, arg_degrees: f32) !void {
        if (mbind_set_spread == null) {
            mbind_set_spread = try api.createMethod("CPUParticles2D", "set_spread");
        }
    ...
    pub fn setTexture(self: *const Self, arg_texture: *const godot.Texture) !void {
        if (mbind_set_texture == null) {
            mbind_set_texture = try api.createMethod("CPUParticles2D", "set_texture");
        }
    ...
    pub fn setUseLocalCoordinates(self: *const Self, arg_enable: bool) !void {
        if (mbind_set_use_local_coordinates == null) {
            mbind_set_use_local_coordinates = try api.createMethod("CPUParticles2D", "set_use_local_coordinates");
        }
