...
var mbind_kinematic_collision_2d_constructor: ?fn () ?*c_api.godot_object = null;

pub const KinematicCollision2D = struct {
    const Self = @This();
    ...
    pub fn init() !*Self {
        if (mbind_kinematic_collision_2d_constructor == null) {
            mbind_kinematic_collision_2d_constructor = try api.createConstructor("KinematicCollision2D");
        }
        return api.createObject(Self, mbind_kinematic_collision_2d_constructor.?);
    }
    ...
    pub fn getAngle(self: *const Self, arg_up_direction: *const godot.Vector2) !f32 {
        if (mbind_get_angle == null) {
            mbind_get_angle = try api.createMethod("KinematicCollision2D", "get_angle");
        }
    ...
    pub fn getCollider(self: *const Self) !godot.Object {
        if (mbind_get_collider == null) {
            mbind_get_collider = try api.createMethod("KinematicCollision2D", "get_collider");
        }
    ...
    pub fn getColliderId(self: *const Self) !i32 {
        if (mbind_get_collider_id == null) {
            mbind_get_collider_id = try api.createMethod("KinematicCollision2D", "get_collider_id");
        }
    ...
    pub fn getColliderMetadata(self: *const Self) !godot.Variant {
        if (mbind_get_collider_metadata == null) {
            mbind_get_collider_metadata = try api.createMethod("KinematicCollision2D", "get_collider_metadata");
        }
    ...
    pub fn getColliderRid(self: *const Self) !godot.RID {
        if (mbind_get_collider_rid == null) {
            mbind_get_collider_rid = try api.createMethod("KinematicCollision2D", "get_collider_rid");
        }
    ...
    pub fn getColliderShape(self: *const Self) !godot.Object {
        if (mbind_get_collider_shape == null) {
            mbind_get_collider_shape = try api.createMethod("KinematicCollision2D", "get_collider_shape");
        }
    ...
    pub fn getColliderShapeIndex(self: *const Self) !i32 {
        if (mbind_get_collider_shape_index == null) {
            mbind_get_collider_shape_index = try api.createMethod("KinematicCollision2D", "get_collider_shape_index");
        }
    ...
    pub fn getColliderVelocity(self: *const Self) !godot.Vector2 {
        if (mbind_get_collider_velocity == null) {
            mbind_get_collider_velocity = try api.createMethod("KinematicCollision2D", "get_collider_velocity");
        }
    ...
    pub fn getLocalShape(self: *const Self) !godot.Object {
        if (mbind_get_local_shape == null) {
            mbind_get_local_shape = try api.createMethod("KinematicCollision2D", "get_local_shape");
        }
    ...
    pub fn getNormal(self: *const Self) !godot.Vector2 {
        if (mbind_get_normal == null) {
            mbind_get_normal = try api.createMethod("KinematicCollision2D", "get_normal");
        }
    ...
    pub fn getPosition(self: *const Self) !godot.Vector2 {
        if (mbind_get_position == null) {
            mbind_get_position = try api.createMethod("KinematicCollision2D", "get_position");
        }
    ...
    pub fn getRemainder(self: *const Self) !godot.Vector2 {
        if (mbind_get_remainder == null) {
            mbind_get_remainder = try api.createMethod("KinematicCollision2D", "get_remainder");
        }
    ...
    pub fn getTravel(self: *const Self) !godot.Vector2 {
        if (mbind_get_travel == null) {
            mbind_get_travel = try api.createMethod("KinematicCollision2D", "get_travel");
        }
