...
var mbind_cylinder_shape_constructor: ?fn () ?*c_api.godot_object = null;
...
pub const CylinderShape = struct {
    ...
    pub fn init() !*Self {
        if (mbind_cylinder_shape_constructor == null) {
            mbind_cylinder_shape_constructor = try api.createConstructor("CylinderShape");
        }
        return api.createObject(Self, mbind_cylinder_shape_constructor.?);
    }
    ...
    pub fn getHeight(self: *const Self) !f32 {
        if (mbind_get_height == null) {
            mbind_get_height = try api.createMethod("CylinderShape", "get_height");
        }
    ...
    pub fn getRadius(self: *const Self) !f32 {
        if (mbind_get_radius == null) {
            mbind_get_radius = try api.createMethod("CylinderShape", "get_radius");
        }
    ...
    pub fn setHeight(self: *const Self, arg_height: f32) !void {
        if (mbind_set_height == null) {
            mbind_set_height = try api.createMethod("CylinderShape", "set_height");
        }
    ...
    pub fn setRadius(self: *const Self, arg_radius: f32) !void {
        if (mbind_set_radius == null) {
            mbind_set_radius = try api.createMethod("CylinderShape", "set_radius");
        }
