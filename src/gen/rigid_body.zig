...
var mbind_get_axis_lock: ?*c_api.godot_method_bind = null;
...
var mbind_get_inverse_inertia_tensor: ?*c_api.godot_method_bind = null;
...
var mbind_is_using_continuous_collision_detection: ?*c_api.godot_method_bind = null;
...
var mbind_set_axis_lock: ?*c_api.godot_method_bind = null;
...
var mbind_set_use_continuous_collision_detection: ?*c_api.godot_method_bind = null;
var mbind_set_use_custom_integrator: ?*c_api.godot_method_bind = null;
var mbind_set_weight: ?*c_api.godot_method_bind = null;
var mbind_rigid_body_constructor: ?fn () ?*c_api.godot_object = null;

pub const RigidBody = struct {
    const Self = @This();
    pub const BaseClass = godot.PhysicsBody;
    ...
    pub fn init() !*Self {
        if (mbind_rigid_body_constructor == null) {
            mbind_rigid_body_constructor = try api.createConstructor("RigidBody");
        }
        return api.createObject(Self, mbind_rigid_body_constructor.?);
    }
    ...
    pub fn addCentralForce(self: *const Self, arg_force: *const godot.Vector3) !void {
        if (mbind_add_central_force == null) {
            mbind_add_central_force = try api.createMethod("RigidBody", "add_central_force");
        }
    ...
    pub fn addForce(self: *const Self, arg_force: *const godot.Vector3, arg_position: *const godot.Vector3) !void {
        if (mbind_add_force == null) {
            mbind_add_force = try api.createMethod("RigidBody", "add_force");
        }
    ...
    pub fn addTorque(self: *const Self, arg_torque: *const godot.Vector3) !void {
        if (mbind_add_torque == null) {
            mbind_add_torque = try api.createMethod("RigidBody", "add_torque");
        }
    ...
    pub fn applyCentralImpulse(self: *const Self, arg_impulse: *const godot.Vector3) !void {
        if (mbind_apply_central_impulse == null) {
            mbind_apply_central_impulse = try api.createMethod("RigidBody", "apply_central_impulse");
        }
    ...
    pub fn applyImpulse(self: *const Self, arg_position: *const godot.Vector3, arg_impulse: *const godot.Vector3) !void {
        if (mbind_apply_impulse == null) {
            mbind_apply_impulse = try api.createMethod("RigidBody", "apply_impulse");
        }
    ...
    pub fn applyTorqueImpulse(self: *const Self, arg_impulse: *const godot.Vector3) !void {
        if (mbind_apply_torque_impulse == null) {
            mbind_apply_torque_impulse = try api.createMethod("RigidBody", "apply_torque_impulse");
        }
    ...
    pub fn getAngularDamp(self: *const Self) !f32 {
        if (mbind_get_angular_damp == null) {
            mbind_get_angular_damp = try api.createMethod("RigidBody", "get_angular_damp");
        }
    ...
    pub fn getAngularVelocity(self: *const Self) !godot.Vector3 {
        if (mbind_get_angular_velocity == null) {
            mbind_get_angular_velocity = try api.createMethod("RigidBody", "get_angular_velocity");
        }
    ...
    pub fn getAxisLock(self: *const Self, arg_axis: i32) !bool {
        if (mbind_get_axis_lock == null) {
            mbind_get_axis_lock = try api.createMethod("RigidBody", "get_axis_lock");
        }
        ...
        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_get_axis_lock, base, cargs, result);
        return @ptrCast(*bool, @alignCast(@alignOf(&bool), result)).*;
    }

    pub fn getBounce(self: *const Self) !f32 {
        if (mbind_get_bounce == null) {
            mbind_get_bounce = try api.createMethod("RigidBody", "get_bounce");
        }
    ...
    pub fn getCollidingBodies(self: *const Self) !godot.Array {
        if (mbind_get_colliding_bodies == null) {
            mbind_get_colliding_bodies = try api.createMethod("RigidBody", "get_colliding_bodies");
        }
    ...
    pub fn getFriction(self: *const Self) !f32 {
        if (mbind_get_friction == null) {
            mbind_get_friction = try api.createMethod("RigidBody", "get_friction");
        }
    ...
    pub fn getGravityScale(self: *const Self) !f32 {
        if (mbind_get_gravity_scale == null) {
            mbind_get_gravity_scale = try api.createMethod("RigidBody", "get_gravity_scale");
        }
    ...
    pub fn getInverseInertiaTensor(self: *const Self) !godot.Basis {
        if (mbind_get_inverse_inertia_tensor == null) {
            mbind_get_inverse_inertia_tensor = try api.createMethod("RigidBody", "get_inverse_inertia_tensor");
        }
        ...
        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_get_inverse_inertia_tensor, base, cargs, result);
    ...
    pub fn getLinearDamp(self: *const Self) !f32 {
        if (mbind_get_linear_damp == null) {
            mbind_get_linear_damp = try api.createMethod("RigidBody", "get_linear_damp");
        }
    ...
    pub fn getLinearVelocity(self: *const Self) !godot.Vector3 {
        if (mbind_get_linear_velocity == null) {
            mbind_get_linear_velocity = try api.createMethod("RigidBody", "get_linear_velocity");
        }
    ...
    pub fn getMass(self: *const Self) !f32 {
        if (mbind_get_mass == null) {
            mbind_get_mass = try api.createMethod("RigidBody", "get_mass");
        }
    ...
    pub fn getMaxContactsReported(self: *const Self) !i32 {
        if (mbind_get_max_contacts_reported == null) {
            mbind_get_max_contacts_reported = try api.createMethod("RigidBody", "get_max_contacts_reported");
        }
    ...
    pub fn getMode(self: *const Self) !i32 {
        if (mbind_get_mode == null) {
            mbind_get_mode = try api.createMethod("RigidBody", "get_mode");
        }
    ...
    pub fn getPhysicsMaterialOverride(self: *const Self) !godot.PhysicsMaterial {
        if (mbind_get_physics_material_override == null) {
            mbind_get_physics_material_override = try api.createMethod("RigidBody", "get_physics_material_override");
        }
    ...
    pub fn getWeight(self: *const Self) !f32 {
        if (mbind_get_weight == null) {
            mbind_get_weight = try api.createMethod("RigidBody", "get_weight");
        }
    ...
    pub fn isAbleToSleep(self: *const Self) !bool {
        if (mbind_is_able_to_sleep == null) {
            mbind_is_able_to_sleep = try api.createMethod("RigidBody", "is_able_to_sleep");
        }
    ...
    pub fn isContactMonitorEnabled(self: *const Self) !bool {
        if (mbind_is_contact_monitor_enabled == null) {
            mbind_is_contact_monitor_enabled = try api.createMethod("RigidBody", "is_contact_monitor_enabled");
        }
    ...
    pub fn isSleeping(self: *const Self) !bool {
        if (mbind_is_sleeping == null) {
            mbind_is_sleeping = try api.createMethod("RigidBody", "is_sleeping");
        }
    ...
    pub fn isUsingContinuousCollisionDetection(self: *const Self) !bool {
        if (mbind_is_using_continuous_collision_detection == null) {
            mbind_is_using_continuous_collision_detection = try api.createMethod("RigidBody", "is_using_continuous_collision_detection");
        }
        ...
        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_is_using_continuous_collision_detection, base, cargs, result);
        return @ptrCast(*bool, @alignCast(@alignOf(&bool), result)).*;
    }

    pub fn isUsingCustomIntegrator(self: *const Self) !bool {
        if (mbind_is_using_custom_integrator == null) {
            mbind_is_using_custom_integrator = try api.createMethod("RigidBody", "is_using_custom_integrator");
        }
    ...
    pub fn setAngularDamp(self: *const Self, arg_angular_damp: f32) !void {
        if (mbind_set_angular_damp == null) {
            mbind_set_angular_damp = try api.createMethod("RigidBody", "set_angular_damp");
        }
    ...
    pub fn setAngularVelocity(self: *const Self, arg_angular_velocity: *const godot.Vector3) !void {
        if (mbind_set_angular_velocity == null) {
            mbind_set_angular_velocity = try api.createMethod("RigidBody", "set_angular_velocity");
        }
    ...
    pub fn setAxisLock(self: *const Self, arg_axis: i32, arg_lock: bool) !void {
        if (mbind_set_axis_lock == null) {
            mbind_set_axis_lock = try api.createMethod("RigidBody", "set_axis_lock");
        }
        ...
        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_set_axis_lock, base, cargs, result);
    }

    pub fn setAxisVelocity(self: *const Self, arg_axis_velocity: *const godot.Vector3) !void {
        if (mbind_set_axis_velocity == null) {
            mbind_set_axis_velocity = try api.createMethod("RigidBody", "set_axis_velocity");
        }
    ...
    pub fn setBounce(self: *const Self, arg_bounce: f32) !void {
        if (mbind_set_bounce == null) {
            mbind_set_bounce = try api.createMethod("RigidBody", "set_bounce");
        }
    ...
    pub fn setCanSleep(self: *const Self, arg_able_to_sleep: bool) !void {
        if (mbind_set_can_sleep == null) {
            mbind_set_can_sleep = try api.createMethod("RigidBody", "set_can_sleep");
        }
    ...
    pub fn setContactMonitor(self: *const Self, arg_enabled: bool) !void {
        if (mbind_set_contact_monitor == null) {
            mbind_set_contact_monitor = try api.createMethod("RigidBody", "set_contact_monitor");
        }
    ...
    pub fn setFriction(self: *const Self, arg_friction: f32) !void {
        if (mbind_set_friction == null) {
            mbind_set_friction = try api.createMethod("RigidBody", "set_friction");
        }
    ...
    pub fn setGravityScale(self: *const Self, arg_gravity_scale: f32) !void {
        if (mbind_set_gravity_scale == null) {
            mbind_set_gravity_scale = try api.createMethod("RigidBody", "set_gravity_scale");
        }
    ...
    pub fn setLinearDamp(self: *const Self, arg_linear_damp: f32) !void {
        if (mbind_set_linear_damp == null) {
            mbind_set_linear_damp = try api.createMethod("RigidBody", "set_linear_damp");
        }
    ...
    pub fn setLinearVelocity(self: *const Self, arg_linear_velocity: *const godot.Vector3) !void {
        if (mbind_set_linear_velocity == null) {
            mbind_set_linear_velocity = try api.createMethod("RigidBody", "set_linear_velocity");
        }
    ...
    pub fn setMass(self: *const Self, arg_mass: f32) !void {
        if (mbind_set_mass == null) {
            mbind_set_mass = try api.createMethod("RigidBody", "set_mass");
        }
    ...
    pub fn setMaxContactsReported(self: *const Self, arg_amount: i32) !void {
        if (mbind_set_max_contacts_reported == null) {
            mbind_set_max_contacts_reported = try api.createMethod("RigidBody", "set_max_contacts_reported");
        }
    ...
    pub fn setMode(self: *const Self, arg_mode: i32) !void {
        if (mbind_set_mode == null) {
            mbind_set_mode = try api.createMethod("RigidBody", "set_mode");
        }
    ...
    pub fn setPhysicsMaterialOverride(self: *const Self, arg_physics_material_override: *const godot.PhysicsMaterial) !void {
        if (mbind_set_physics_material_override == null) {
            mbind_set_physics_material_override = try api.createMethod("RigidBody", "set_physics_material_override");
        }
    ...
    pub fn setSleeping(self: *const Self, arg_sleeping: bool) !void {
        if (mbind_set_sleeping == null) {
            mbind_set_sleeping = try api.createMethod("RigidBody", "set_sleeping");
        }
    ...
    pub fn setUseContinuousCollisionDetection(self: *const Self, arg_enable: bool) !void {
        if (mbind_set_use_continuous_collision_detection == null) {
            mbind_set_use_continuous_collision_detection = try api.createMethod("RigidBody", "set_use_continuous_collision_detection");
        }
        ...
        const base = @ptrCast(*c_api.godot_object, @alignCast(@alignOf(*c_api.godot_object), self.base));
        _ = api.core.?.godot_method_bind_ptrcall.?(mbind_set_use_continuous_collision_detection, base, cargs, result);
    }

    pub fn setUseCustomIntegrator(self: *const Self, arg_enable: bool) !void {
        if (mbind_set_use_custom_integrator == null) {
            mbind_set_use_custom_integrator = try api.createMethod("RigidBody", "set_use_custom_integrator");
        }
    ...
    pub fn setWeight(self: *const Self, arg_weight: f32) !void {
        if (mbind_set_weight == null) {
            mbind_set_weight = try api.createMethod("RigidBody", "set_weight");
        }
