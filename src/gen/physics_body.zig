...
var mbind_physics_body_constructor: ?fn () ?*c_api.godot_object = null;

pub const PhysicsBody = struct {
    const Self = @This();
    pub const BaseClass = godot.CollisionObject;
    ...
    pub fn init() !*Self {
        if (mbind_physics_body_constructor == null) {
            mbind_physics_body_constructor = try api.createConstructor("PhysicsBody");
        }
        return api.createObject(Self, mbind_physics_body_constructor.?);
    }
    ...
    pub fn addCollisionExceptionWith(self: *const Self, arg_body: *const godot.Node) !void {
        if (mbind_add_collision_exception_with == null) {
            mbind_add_collision_exception_with = try api.createMethod("PhysicsBody", "add_collision_exception_with");
        }
    ...
    pub fn getCollisionExceptions(self: *const Self) !godot.Array {
        if (mbind_get_collision_exceptions == null) {
            mbind_get_collision_exceptions = try api.createMethod("PhysicsBody", "get_collision_exceptions");
        }
    ...
    pub fn removeCollisionExceptionWith(self: *const Self, arg_body: *const godot.Node) !void {
        if (mbind_remove_collision_exception_with == null) {
            mbind_remove_collision_exception_with = try api.createMethod("PhysicsBody", "remove_collision_exception_with");
        }
