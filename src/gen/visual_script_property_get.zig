...
var mbind_visual_script_property_get_constructor: ?fn () ?*c_api.godot_object = null;

pub const VisualScriptPropertyGet = struct {
    const Self = @This();
    ...
    pub fn init() !*Self {
        if (mbind_visual_script_property_get_constructor == null) {
            mbind_visual_script_property_get_constructor = try api.createConstructor("VisualScriptPropertyGet");
        }
        return api.createObject(Self, mbind_visual_script_property_get_constructor.?);
    }
    ...
    pub fn getBasePath(self: *const Self) !godot.NodePath {
        if (mbind_get_base_path == null) {
            mbind_get_base_path = try api.createMethod("VisualScriptPropertyGet", "get_base_path");
        }
    ...
    pub fn getBaseScript(self: *const Self) !godot.String {
        if (mbind_get_base_script == null) {
            mbind_get_base_script = try api.createMethod("VisualScriptPropertyGet", "get_base_script");
        }
    ...
    pub fn getBaseType(self: *const Self) !godot.String {
        if (mbind_get_base_type == null) {
            mbind_get_base_type = try api.createMethod("VisualScriptPropertyGet", "get_base_type");
        }
    ...
    pub fn getBasicType(self: *const Self) !i32 {
        if (mbind_get_basic_type == null) {
            mbind_get_basic_type = try api.createMethod("VisualScriptPropertyGet", "get_basic_type");
        }
    ...
    pub fn getCallMode(self: *const Self) !i32 {
        if (mbind_get_call_mode == null) {
            mbind_get_call_mode = try api.createMethod("VisualScriptPropertyGet", "get_call_mode");
        }
    ...
    pub fn getIndex(self: *const Self) !godot.String {
        if (mbind_get_index == null) {
            mbind_get_index = try api.createMethod("VisualScriptPropertyGet", "get_index");
        }
    ...
    pub fn getProperty(self: *const Self) !godot.String {
        if (mbind_get_property == null) {
            mbind_get_property = try api.createMethod("VisualScriptPropertyGet", "get_property");
        }
    ...
    pub fn setBasePath(self: *const Self, arg_base_path: *const godot.NodePath) !void {
        if (mbind_set_base_path == null) {
            mbind_set_base_path = try api.createMethod("VisualScriptPropertyGet", "set_base_path");
        }
    ...
    pub fn setBaseScript(self: *const Self, arg_base_script: *const godot.String) !void {
        if (mbind_set_base_script == null) {
            mbind_set_base_script = try api.createMethod("VisualScriptPropertyGet", "set_base_script");
        }
    ...
    pub fn setBaseType(self: *const Self, arg_base_type: *const godot.String) !void {
        if (mbind_set_base_type == null) {
            mbind_set_base_type = try api.createMethod("VisualScriptPropertyGet", "set_base_type");
        }
    ...
    pub fn setBasicType(self: *const Self, arg_basic_type: i32) !void {
        if (mbind_set_basic_type == null) {
            mbind_set_basic_type = try api.createMethod("VisualScriptPropertyGet", "set_basic_type");
        }
    ...
    pub fn setCallMode(self: *const Self, arg_mode: i32) !void {
        if (mbind_set_call_mode == null) {
            mbind_set_call_mode = try api.createMethod("VisualScriptPropertyGet", "set_call_mode");
        }
    ...
    pub fn setIndex(self: *const Self, arg_index: *const godot.String) !void {
        if (mbind_set_index == null) {
            mbind_set_index = try api.createMethod("VisualScriptPropertyGet", "set_index");
        }
    ...
    pub fn setProperty(self: *const Self, arg_property: *const godot.String) !void {
        if (mbind_set_property == null) {
            mbind_set_property = try api.createMethod("VisualScriptPropertyGet", "set_property");
        }
