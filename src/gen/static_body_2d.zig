...
var mbind_static_body_2d_constructor: ?fn () ?*c_api.godot_object = null;
...
pub const StaticBody2D = struct {
    ...
    pub fn init() !*Self {
        if (mbind_static_body_2d_constructor == null) {
            mbind_static_body_2d_constructor = try api.createConstructor("StaticBody2D");
        }
        return api.createObject(Self, mbind_static_body_2d_constructor.?);
    }
    ...
    pub fn getBounce(self: *const Self) !f32 {
        if (mbind_get_bounce == null) {
            mbind_get_bounce = try api.createMethod("StaticBody2D", "get_bounce");
        }
    ...
    pub fn getConstantAngularVelocity(self: *const Self) !f32 {
        if (mbind_get_constant_angular_velocity == null) {
            mbind_get_constant_angular_velocity = try api.createMethod("StaticBody2D", "get_constant_angular_velocity");
        }
    ...
    pub fn getConstantLinearVelocity(self: *const Self) !godot.Vector2 {
        if (mbind_get_constant_linear_velocity == null) {
            mbind_get_constant_linear_velocity = try api.createMethod("StaticBody2D", "get_constant_linear_velocity");
        }
    ...
    pub fn getFriction(self: *const Self) !f32 {
        if (mbind_get_friction == null) {
            mbind_get_friction = try api.createMethod("StaticBody2D", "get_friction");
        }
    ...
    pub fn getPhysicsMaterialOverride(self: *const Self) !godot.PhysicsMaterial {
        if (mbind_get_physics_material_override == null) {
            mbind_get_physics_material_override = try api.createMethod("StaticBody2D", "get_physics_material_override");
        }
    ...
    pub fn setBounce(self: *const Self, arg_bounce: f32) !void {
        if (mbind_set_bounce == null) {
            mbind_set_bounce = try api.createMethod("StaticBody2D", "set_bounce");
        }
    ...
    pub fn setConstantAngularVelocity(self: *const Self, arg_vel: f32) !void {
        if (mbind_set_constant_angular_velocity == null) {
            mbind_set_constant_angular_velocity = try api.createMethod("StaticBody2D", "set_constant_angular_velocity");
        }
    ...
    pub fn setConstantLinearVelocity(self: *const Self, arg_vel: *const godot.Vector2) !void {
        if (mbind_set_constant_linear_velocity == null) {
            mbind_set_constant_linear_velocity = try api.createMethod("StaticBody2D", "set_constant_linear_velocity");
        }
    ...
    pub fn setFriction(self: *const Self, arg_friction: f32) !void {
        if (mbind_set_friction == null) {
            mbind_set_friction = try api.createMethod("StaticBody2D", "set_friction");
        }
    ...
    pub fn setPhysicsMaterialOverride(self: *const Self, arg_physics_material_override: *const godot.PhysicsMaterial) !void {
        if (mbind_set_physics_material_override == null) {
            mbind_set_physics_material_override = try api.createMethod("StaticBody2D", "set_physics_material_override");
        }
