...
var mbind_circle_shape_2d_constructor: ?fn () ?*c_api.godot_object = null;

pub const CircleShape2D = struct {
    const Self = @This();
    ...
    pub fn init() !*Self {
        if (mbind_circle_shape_2d_constructor == null) {
            mbind_circle_shape_2d_constructor = try api.createConstructor("CircleShape2D");
        }
        return api.createObject(Self, mbind_circle_shape_2d_constructor.?);
    }
    ...
    pub fn getRadius(self: *const Self) !f32 {
        if (mbind_get_radius == null) {
            mbind_get_radius = try api.createMethod("CircleShape2D", "get_radius");
        }
    ...
    pub fn setRadius(self: *const Self, arg_radius: f32) !void {
        if (mbind_set_radius == null) {
            mbind_set_radius = try api.createMethod("CircleShape2D", "set_radius");
        }
