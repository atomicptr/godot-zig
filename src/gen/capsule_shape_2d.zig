...
var mbind_capsule_shape_2d_constructor: ?fn () ?*c_api.godot_object = null;

pub const CapsuleShape2D = struct {
    const Self = @This();
    ...
    pub fn init() !*Self {
        if (mbind_capsule_shape_2d_constructor == null) {
            mbind_capsule_shape_2d_constructor = try api.createConstructor("CapsuleShape2D");
        }
        return api.createObject(Self, mbind_capsule_shape_2d_constructor.?);
    }
    ...
    pub fn getHeight(self: *const Self) !f32 {
        if (mbind_get_height == null) {
            mbind_get_height = try api.createMethod("CapsuleShape2D", "get_height");
        }
    ...
    pub fn getRadius(self: *const Self) !f32 {
        if (mbind_get_radius == null) {
            mbind_get_radius = try api.createMethod("CapsuleShape2D", "get_radius");
        }
    ...
    pub fn setHeight(self: *const Self, arg_height: f32) !void {
        if (mbind_set_height == null) {
            mbind_set_height = try api.createMethod("CapsuleShape2D", "set_height");
        }
    ...
    pub fn setRadius(self: *const Self, arg_radius: f32) !void {
        if (mbind_set_radius == null) {
            mbind_set_radius = try api.createMethod("CapsuleShape2D", "set_radius");
        }
