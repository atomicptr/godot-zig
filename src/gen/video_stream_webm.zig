...
var mbind_video_stream_webm_constructor: ?fn () ?*c_api.godot_object = null;

pub const VideoStreamWebm = struct {
    const Self = @This();
    ...
    pub fn init() !*Self {
        if (mbind_video_stream_webm_constructor == null) {
            mbind_video_stream_webm_constructor = try api.createConstructor("VideoStreamWebm");
        }
        return api.createObject(Self, mbind_video_stream_webm_constructor.?);
    }
    ...
    pub fn getFile(self: *const Self) !godot.String {
        if (mbind_get_file == null) {
            mbind_get_file = try api.createMethod("VideoStreamWebm", "get_file");
        }
    ...
    pub fn setFile(self: *const Self, arg_file: *const godot.String) !void {
        if (mbind_set_file == null) {
            mbind_set_file = try api.createMethod("VideoStreamWebm", "set_file");
        }
