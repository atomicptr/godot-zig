...
var mbind_pin_joint_constructor: ?fn () ?*c_api.godot_object = null;
...
pub const PinJoint = struct {
    ...
    pub fn init() !*Self {
        if (mbind_pin_joint_constructor == null) {
            mbind_pin_joint_constructor = try api.createConstructor("PinJoint");
        }
        return api.createObject(Self, mbind_pin_joint_constructor.?);
    }
    ...
    pub fn getParam(self: *const Self, arg_param: i32) !f32 {
        if (mbind_get_param == null) {
            mbind_get_param = try api.createMethod("PinJoint", "get_param");
        }
    ...
    pub fn setParam(self: *const Self, arg_param: i32, arg_value: f32) !void {
        if (mbind_set_param == null) {
            mbind_set_param = try api.createMethod("PinJoint", "set_param");
        }
