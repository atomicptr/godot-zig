...
var mbind_hmaccontext_constructor: ?fn () ?*c_api.godot_object = null;
...
pub const HMACContext = struct {
    ...
    pub fn init() !*Self {
        if (mbind_hmaccontext_constructor == null) {
            mbind_hmaccontext_constructor = try api.createConstructor("HMACContext");
        }
        return api.createObject(Self, mbind_hmaccontext_constructor.?);
    }
    ...
    pub fn finish(self: *const Self) !godot.PoolByteArray {
        if (mbind_finish == null) {
            mbind_finish = try api.createMethod("HMACContext", "finish");
        }
    ...
    pub fn start(self: *const Self, arg_hash_type: i32, arg_key: *const godot.PoolByteArray) !i32 {
        if (mbind_start == null) {
            mbind_start = try api.createMethod("HMACContext", "start");
        }
    ...
    pub fn update(self: *const Self, arg_data: *const godot.PoolByteArray) !i32 {
        if (mbind_update == null) {
            mbind_update = try api.createMethod("HMACContext", "update");
        }
