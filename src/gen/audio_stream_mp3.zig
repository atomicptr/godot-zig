...
var mbind_audio_stream_mp3_constructor: ?fn () ?*c_api.godot_object = null;

pub const AudioStreamMP3 = struct {
    const Self = @This();
    ...
    pub fn init() !*Self {
        if (mbind_audio_stream_mp3_constructor == null) {
            mbind_audio_stream_mp3_constructor = try api.createConstructor("AudioStreamMP3");
        }
        return api.createObject(Self, mbind_audio_stream_mp3_constructor.?);
    }
    ...
    pub fn getData(self: *const Self) !godot.PoolByteArray {
        if (mbind_get_data == null) {
            mbind_get_data = try api.createMethod("AudioStreamMP3", "get_data");
        }
    ...
    pub fn getLoopOffset(self: *const Self) !f32 {
        if (mbind_get_loop_offset == null) {
            mbind_get_loop_offset = try api.createMethod("AudioStreamMP3", "get_loop_offset");
        }
    ...
    pub fn hasLoop(self: *const Self) !bool {
        if (mbind_has_loop == null) {
            mbind_has_loop = try api.createMethod("AudioStreamMP3", "has_loop");
        }
    ...
    pub fn setData(self: *const Self, arg_data: *const godot.PoolByteArray) !void {
        if (mbind_set_data == null) {
            mbind_set_data = try api.createMethod("AudioStreamMP3", "set_data");
        }
    ...
    pub fn setLoop(self: *const Self, arg_enable: bool) !void {
        if (mbind_set_loop == null) {
            mbind_set_loop = try api.createMethod("AudioStreamMP3", "set_loop");
        }
    ...
    pub fn setLoopOffset(self: *const Self, arg_seconds: f32) !void {
        if (mbind_set_loop_offset == null) {
            mbind_set_loop_offset = try api.createMethod("AudioStreamMP3", "set_loop_offset");
        }
