...
var mbind_kinematic_body_constructor: ?fn () ?*c_api.godot_object = null;
...
pub const KinematicBody = struct {
    ...
    pub fn init() !*Self {
        if (mbind_kinematic_body_constructor == null) {
            mbind_kinematic_body_constructor = try api.createConstructor("KinematicBody");
        }
        return api.createObject(Self, mbind_kinematic_body_constructor.?);
    }
    ...
    pub fn getAxisLock(self: *const Self, arg_axis: i32) !bool {
        if (mbind_get_axis_lock == null) {
            mbind_get_axis_lock = try api.createMethod("KinematicBody", "get_axis_lock");
        }
    ...
    pub fn getFloorAngle(self: *const Self, arg_up_direction: *const godot.Vector3) !f32 {
        if (mbind_get_floor_angle == null) {
            mbind_get_floor_angle = try api.createMethod("KinematicBody", "get_floor_angle");
        }
    ...
    pub fn getFloorNormal(self: *const Self) !godot.Vector3 {
        if (mbind_get_floor_normal == null) {
            mbind_get_floor_normal = try api.createMethod("KinematicBody", "get_floor_normal");
        }
    ...
    pub fn getFloorVelocity(self: *const Self) !godot.Vector3 {
        if (mbind_get_floor_velocity == null) {
            mbind_get_floor_velocity = try api.createMethod("KinematicBody", "get_floor_velocity");
        }
    ...
    pub fn getLastSlideCollision(self: *const Self) !godot.KinematicCollision {
        if (mbind_get_last_slide_collision == null) {
            mbind_get_last_slide_collision = try api.createMethod("KinematicBody", "get_last_slide_collision");
        }
        ...
        return @ptrCast(*godot.KinematicCollision, @alignCast(@alignOf(&godot.KinematicCollision), result)).*;
    }

    pub fn getSafeMargin(self: *const Self) !f32 {
        if (mbind_get_safe_margin == null) {
            mbind_get_safe_margin = try api.createMethod("KinematicBody", "get_safe_margin");
        }
    ...
    pub fn getSlideCollision(self: *const Self, arg_slide_idx: i32) !godot.KinematicCollision {
        if (mbind_get_slide_collision == null) {
            mbind_get_slide_collision = try api.createMethod("KinematicBody", "get_slide_collision");
        }
    ...
    pub fn getSlideCount(self: *const Self) !i32 {
        if (mbind_get_slide_count == null) {
            mbind_get_slide_count = try api.createMethod("KinematicBody", "get_slide_count");
        }
    ...
    pub fn isOnCeiling(self: *const Self) !bool {
        if (mbind_is_on_ceiling == null) {
            mbind_is_on_ceiling = try api.createMethod("KinematicBody", "is_on_ceiling");
        }
    ...
    pub fn isOnFloor(self: *const Self) !bool {
        if (mbind_is_on_floor == null) {
            mbind_is_on_floor = try api.createMethod("KinematicBody", "is_on_floor");
        }
    ...
    pub fn isOnWall(self: *const Self) !bool {
        if (mbind_is_on_wall == null) {
            mbind_is_on_wall = try api.createMethod("KinematicBody", "is_on_wall");
        }
    ...
    pub fn isSyncToPhysicsEnabled(self: *const Self) !bool {
        if (mbind_is_sync_to_physics_enabled == null) {
            mbind_is_sync_to_physics_enabled = try api.createMethod("KinematicBody", "is_sync_to_physics_enabled");
        }
    ...
    pub fn moveAndCollide(self: *const Self, arg_rel_vec: *const godot.Vector3, arg_infinite_inertia: bool, arg_exclude_raycast_shapes: bool, arg_test_only: bool) !godot.KinematicCollision {
        if (mbind_move_and_collide == null) {
            mbind_move_and_collide = try api.createMethod("KinematicBody", "move_and_collide");
        }
    ...
    pub fn moveAndSlide(self: *const Self, arg_linear_velocity: *const godot.Vector3, arg_up_direction: *const godot.Vector3, arg_stop_on_slope: bool, arg_max_slides: i32, arg_floor_max_angle: f32, arg_infinite_inertia: bool) !godot.Vector3 {
        if (mbind_move_and_slide == null) {
            mbind_move_and_slide = try api.createMethod("KinematicBody", "move_and_slide");
        }
    ...
    pub fn moveAndSlideWithSnap(self: *const Self, arg_linear_velocity: *const godot.Vector3, arg_snap: *const godot.Vector3, arg_up_direction: *const godot.Vector3, arg_stop_on_slope: bool, arg_max_slides: i32, arg_floor_max_angle: f32, arg_infinite_inertia: bool) !godot.Vector3 {
        if (mbind_move_and_slide_with_snap == null) {
            mbind_move_and_slide_with_snap = try api.createMethod("KinematicBody", "move_and_slide_with_snap");
        }
    ...
    pub fn setAxisLock(self: *const Self, arg_axis: i32, arg_lock: bool) !void {
        if (mbind_set_axis_lock == null) {
            mbind_set_axis_lock = try api.createMethod("KinematicBody", "set_axis_lock");
        }
    ...
    pub fn setSafeMargin(self: *const Self, arg_pixels: f32) !void {
        if (mbind_set_safe_margin == null) {
            mbind_set_safe_margin = try api.createMethod("KinematicBody", "set_safe_margin");
        }
    ...
    pub fn setSyncToPhysics(self: *const Self, arg_enable: bool) !void {
        if (mbind_set_sync_to_physics == null) {
            mbind_set_sync_to_physics = try api.createMethod("KinematicBody", "set_sync_to_physics");
        }
    ...
    pub fn testMove(self: *const Self, arg_from: *const godot.Transform, arg_rel_vec: *const godot.Vector3, arg_infinite_inertia: bool) !bool {
        if (mbind_test_move == null) {
            mbind_test_move = try api.createMethod("KinematicBody", "test_move");
        }
