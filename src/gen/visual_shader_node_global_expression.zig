...
pub const VisualShaderNodeGlobalExpression = struct {
    ...
    pub fn init() !*Self {
        if (mbind_visual_shader_node_global_expression_constructor == null) {
            mbind_visual_shader_node_global_expression_constructor = try api.createConstructor("VisualShaderNodeGlobalExpression");
        }
        return api.createObject(Self, mbind_visual_shader_node_global_expression_constructor.?);
    }
