...
// base class
const TextureLayered = @import("texture_layered.zig").TextureLayered;

// method bindings
var mbind_create: ?*c_api.godot_method_bind = null;
var mbind_texture_3d_constructor: ?fn () ?*c_api.godot_object = null;

pub const Texture3D = struct {
    const Self = @This();
    const BaseClass = TextureLayered;
    ...
    pub fn init() !*Self {
        if (mbind_texture_3d_constructor == null) {
            mbind_texture_3d_constructor = try api.createConstructor("Texture3D");
        }
        return api.createObject(Self, mbind_texture_3d_constructor.?);
    }
    ...
    pub fn create(self: *const Self, arg_width: i32, arg_height: i32, arg_depth: i32, arg_format: i32, arg_flags: i32) !void {
        if (mbind_create == null) {
            mbind_create = try api.createMethod("Texture3D", "create");
        }
