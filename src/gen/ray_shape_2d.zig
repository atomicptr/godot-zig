...
var mbind_ray_shape_2d_constructor: ?fn () ?*c_api.godot_object = null;

pub const RayShape2D = struct {
    const Self = @This();
    ...
    pub fn init() !*Self {
        if (mbind_ray_shape_2d_constructor == null) {
            mbind_ray_shape_2d_constructor = try api.createConstructor("RayShape2D");
        }
        return api.createObject(Self, mbind_ray_shape_2d_constructor.?);
    }
    ...
    pub fn getLength(self: *const Self) !f32 {
        if (mbind_get_length == null) {
            mbind_get_length = try api.createMethod("RayShape2D", "get_length");
        }
    ...
    pub fn getSlipsOnSlope(self: *const Self) !bool {
        if (mbind_get_slips_on_slope == null) {
            mbind_get_slips_on_slope = try api.createMethod("RayShape2D", "get_slips_on_slope");
        }
    ...
    pub fn setLength(self: *const Self, arg_length: f32) !void {
        if (mbind_set_length == null) {
            mbind_set_length = try api.createMethod("RayShape2D", "set_length");
        }
    ...
    pub fn setSlipsOnSlope(self: *const Self, arg_active: bool) !void {
        if (mbind_set_slips_on_slope == null) {
            mbind_set_slips_on_slope = try api.createMethod("RayShape2D", "set_slips_on_slope");
        }
